...
class GestureRecognizer:
    ...
    options = vision.GestureRecognizerOptions(
        ...
        canned_gesture_classifier_options=ClassifierOptions(
            category_allowlist=["None", "Closed_Fist", "Pointing_Up", "Thumb_Down", "Thumb_Up", "ILoveYou"]),
    )
    def __init__(self, queue):
        self.recognizer = vision.GestureRecognizer.create_from_options(GestureRecognizer.options)
    ...
    def run(self):
        ...
        while True:
            ...
            if gesture != last_gesture:
                ...
                self.gesture_data_publisher.set_gesture_data(gesture)
